...
public class CatImageActivity extends AppCompatActivity {
    ...
    private void parseJSON(){
        String url = "https://pixabay.com/api/?key=12623977-e13d4681b6bedcc2c963961cc&q=cat&image_type=photo&pretty=true";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mImageAdapter = new ImageAdapter(CatImageActivity.this, mImageList);
